...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      fAddress: 'the address where the appliance is',
    ...
    es: {
      ...
      fAddress: 'la dirección donde está el electrodoméstico',
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      var fields = [
        ...
        { el: document.getElementById('fAddress'), label: T.fAddress },
      ...
      var body = [
        ...
        T.mailAddress + ': ' + (data.get('direccion') || T.mailNone),
        '',
        T.mailMessage + ':',
        data.get('mensaje')
      ].join('\n');
